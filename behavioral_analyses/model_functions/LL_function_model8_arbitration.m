function f = LL_function_model8_arbitration(params,P)

%This function calculates the loglikelihood of a model to estimate arbitration
%between imitation and emulation.
%Includes 5 parameters: emulation decision softmax beta, imitation decision
%softmax beta, bias towards one strategy, imitation learning rate (alpha),
%and trust in current token values (lambda).
...
for t=1:tr_nb
    ...
    if tr_type(t)==1 %observe
        ...
        %Imitation - Calculate PE (of the partner's action value)
